...
CC=icx CFLAGS="-flto=thin" CXX=icpx CXXFLAGS="-flto=thin" LDFLAGS='-Wl,--as-needed -fuse-ld=lld' cmake --install-prefix /opt/musical-octo-fortnight/usr -DCMAKE_BUILD_TYPE=Release -DMI_SECURE=ON .
