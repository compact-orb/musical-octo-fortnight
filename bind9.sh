...
function configure {
	autoreconf --install
	CC=icx CFLAGS="-D_FORTIFY_SOURCE=3 -O3 -flto=thin -fstack-protector-strong -ipo -march=x86-64-v3 -mtune=haswell -pipe $1" LDFLAGS='-fuse-ld=lld' ./configure --prefix=/opt/musical-octo-fortnight/usr
}
